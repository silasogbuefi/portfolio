  ...
  return (
    <>
        ...
        <nav 
            ...
            justify-between z-50 ${isScroll ? "bg-white bg-white/50 backdrop-blur-lg shadow-sm dark:bg-(--darkTheme) dark:shadow-white/20" : ""}`}>
            <a href='#top'>
                <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt='' className='w-28 cursor-pointer mr-14' />
            </a>
            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 
            rounded-full px-12 py-3 ${isScroll ? "" : "bg-white/50 shadow-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"} `}>
                <li>
                ...
                <li>
                    <a className='font-Ovo' href="#works">Works</a>
                </li>
                <li>
