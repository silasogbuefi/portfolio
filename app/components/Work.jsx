...
const Work = ({isDarkMode}) => {
  return (
    <motion.div 
        ...
        className='text-center text-5xl font-Ovo'>Latest works</motion.h2>
        <motion.p 
        initial={{opacity: 0}}
        whileInView={{opacity: 1}}
        transition={{duration: 0.5, delay: 0.7}}
        className='text-center max-w-2xl mx-auto mt-5 mb-2 --fontOvo'>
        Passionate about creating and maintaining quality assurance processes to ensure top-notch product performance and customer satisfaction.
        </motion.p>
        ...
        <motion.div 
            ...
            className='grid grid-cols-(--autoGrid) my-10 gap-5 dark:text-black'>
